...
public class MainControllerTests {
    ...
    public void testMarkOrderAsPaid_OrderFoundAndNotPaid_ShouldMarkAsPaid() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.put("/order/1/markAsPaid")
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
    ...
    @Test
    @WithMockUser(username = "manager", roles = "MANAGER")
    public void testMarkOrderAsPaid_OrderFoundAndAlreadyPaid_ShouldReturnBadRequest() throws Exception {
        Order order = new Order();
        order.setId(2L);
        ...
        mockMvc.perform(MockMvcRequestBuilders.put("/order/2/markAsPaid")
                        .contentType(MediaType.APPLICATION_JSON))
    ...
    public void testMarkOrderAsPaid_OrderNotFound_ShouldReturnNotFound() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.put("/order/3/markAsPaid")
                        .contentType(MediaType.APPLICATION_JSON))
